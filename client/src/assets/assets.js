...
export const viewApplicationsPageData = [
    { _id: 1, name: "Richard Sanford", rollNumber: "210430001", branch: "CSE", year: "2025", jobTitle: "Full Stack Developer", company: "Amazon", location: "Bangalore", imgSrc: profile_img },
    { _id: 2, name: "Enrique Murphy", rollNumber: "210430002", branch: "IT", year: "2025", jobTitle: "Data Scientist", company: "Meta", location: "San Francisco", imgSrc: profile_img },
    { _id: 3, name: "Alison Powell", rollNumber: "220430003", branch: "ECE", year: "2026", jobTitle: "Marketing Manager", company: "Google", location: "London", imgSrc: profile_img },
    { _id: 4, name: "Richard Sanford", rollNumber: "210430001", branch: "CSE", year: "2025", jobTitle: "UI/UX Designer", company: "Qualcomm", location: "Dubai", imgSrc: profile_img },
    { _id: 5, name: "Enrique Murphy", rollNumber: "210430002", branch: "IT", year: "2025", jobTitle: "Full Stack Developer", company: "Microsoft", location: "Hyderabad", imgSrc: profile_img },
    { _id: 6, name: "Alison Powell", rollNumber: "220430003", branch: "ECE", year: "2026", jobTitle: "Data Scientist", company: "Adobe", location: "New Delhi", imgSrc: profile_img },
    { _id: 7, name: "Richard Sanford", rollNumber: "210430001", branch: "CSE", year: "2025", jobTitle: "Marketing Manager", company: "Samsung", location: "Chennai", imgSrc: profile_img },
];
...
export const initialNotices = [
    { _id: '1', title: "Amazon Drive Rescheduled", content: "The online assessment for Amazon has been moved to Oct 28th.", urgency: "Urgent", date: 1729681667114 },
    { _id: '2', title: "Resume Building Session", content: "Join the TPO session on building ATS-friendly resumes this Friday.", urgency: "General", date: 1729600000000 },
];

export const initialCompanies = [
    { _id: '1', name: "Amazon", sector: "E-Commerce", tag: "Upcoming Drive", logo: amazon_logo },
    { _id: '2', name: "Google", sector: "Technology", tag: "In Discussion", logo: company_icon },
    { _id: '3', name: "FakeStart", sector: "Consulting", tag: "Fraud/Blacklisted", logo: company_icon },
];

export const initialOfferLetters = [
    { _id: '1', name: "Richard Sanford", rollNumber: "210430001", branch: "CSE", year: "2025", company: "Amazon", package: "44 LPA", date: 1729681667114, letterUrl: "#" },
    { _id: '2', name: "Alison Powell", rollNumber: "220430003", branch: "ECE", year: "2026", company: "Microsoft", package: "51 LPA", date: 1729681667114, letterUrl: "#" },
];

export const initialStudents = [
    { _id: '1', name: "Richard Sanford", rollNumber: "210430001", branch: "CSE", isBlacklisted: false, blacklistReason: "" },
    { _id: '2', name: "Enrique Murphy", rollNumber: "210430002", branch: "IT", isBlacklisted: true, blacklistReason: "Did not attend Google interview" },
    { _id: '3', name: "Alison Powell", rollNumber: "220430003", branch: "ECE", isBlacklisted: false, blacklistReason: "" },
];

export const initialQueries = [
    { _id: '1', studentName: "Richard Sanford", query: "Am I eligible for the Google drive if my CGPA is 6.8?", isResolved: false, reply: "" },
    { _id: '2', studentName: "Enrique Murphy", query: "Can I update my uploaded resume?", isResolved: true, reply: "Yes, you can upload a new resume from your profile dashboard." },
];